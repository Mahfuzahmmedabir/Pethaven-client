    ...
    <Card className="p-5">
      <div className="mt-10 flex  gap-8">
        ...
        <div className="w-6/12">
          ...
          <Typography color="blue-gray" className="mb-2">
            <span className="text-gray-700 font-semibold">Age: </span> {age}{' '}
            Year
          </Typography>
          <Typography color="blue-gray" className="mb-2">
          ...
          <Typography color="blue-gray" className="mb-2">
            <span className="text-gray-700 font-semibold">Note: </span> {note}
          </Typography>
          <Typography color="blue-gray" className="mb-2">
            <span className="text-gray-700 font-semibold">Descriptions: </span>
            {descriptions}
          </Typography>
